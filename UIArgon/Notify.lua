...
local function S6_func()
    ...
    S12_.Name = "OpenClose"
    S12_.Parent =
        S4_:IsStudio() and S3_.PlayerGui or
        (gethui() or cloneref(game:GetService("CoreGui")) or game:GetService("CoreGui"))
    ...
    S13_.InputBegan:Connect(
        function(S20_arg0)
            if
                S20_arg0.UserInputType == Enum.UserInputType.Touch or
                    S20_arg0.UserInputType == Enum.UserInputType.MouseButton1
             then
                S14_ = true
                S15_ = S20_arg0.Position
                S16_ = S13_.Position

                S20_arg0.Changed:Connect(
                    function()
    ...
    S13_.InputChanged:Connect(
        function(S21_arg0)
            if
                S14_ and
                    (S21_arg0.UserInputType == Enum.UserInputType.MouseMovement or
                        S21_arg0.UserInputType == Enum.UserInputType.Touch)
             then
                S17_func(S21_arg0)
            end
        end
...
local function S8_func(S22_arg0, S23_arg1)
    local function S24_func(S26_arg0, S27_arg1)
        ...
        S26_arg0.InputBegan:Connect(
            function(S36_arg0)
                if
                    S36_arg0.UserInputType == Enum.UserInputType.MouseButton1 or
                        S36_arg0.UserInputType == Enum.UserInputType.Touch
                 then
                    S28_ = true
                    S30_ = S36_arg0.Position
                    S31_ = S27_arg1.Position

                    S36_arg0.Changed:Connect(
                        function()
        ...
        S26_arg0.InputChanged:Connect(
            function(S37_arg0)
                if
                    S37_arg0.UserInputType == Enum.UserInputType.MouseMovement or
                        S37_arg0.UserInputType == Enum.UserInputType.Touch
                 then
                    S29_ = S37_arg0
                end
            end
    ...
    local function S25_func(S39_arg0)
        ...
        S46_.InputBegan:Connect(
            function(S53_arg0)
                if
                    S53_arg0.UserInputType == Enum.UserInputType.MouseButton1 or
                        S53_arg0.UserInputType == Enum.UserInputType.Touch
                 then
                    S40_ = true
                    S42_ = S53_arg0.Position
                    S43_ = S39_arg0.Size
                    S53_arg0.Changed:Connect(
                        function()
        ...
        S46_.InputChanged:Connect(
            function(S54_arg0)
                if
                    S54_arg0.UserInputType == Enum.UserInputType.MouseMovement or
                        S54_arg0.UserInputType == Enum.UserInputType.Touch
                 then
                    S41_ = S54_arg0
                end
            end
...
function CircleClick(S56_arg0, S57_arg1, S58_arg2)
    spawn(
        function()
            ...
            local S63_ = 0.5
            S59_:TweenSizeAndPosition(
                UDim2.new(0, S62_, 0, S62_),
                UDim2.new(0.5, -S62_ / 2, 0.5, -S62_ / 2),
                "Out",
                "Quad",
                S63_,
                false,
    ...
    spawn(
        function()
            ...
            if not game:GetService("CoreGui").NotifyGui:FindFirstChild("NotifyLayout") then
                ...
                local S86_ = 0
                game:GetService("CoreGui").NotifyGui.NotifyLayout.ChildRemoved:Connect(
                    function()
                        S86_ = 0
            ...
            function S67_:Close()
                ...
                S2_:Create(
                    S70_,
                    TweenInfo.new(tonumber(S66_.Time), Enum.EasingStyle.Back, Enum.EasingDirection.InOut),
                    {
...
function S9_:MakeGui(S91_arg0)
    ...
    S95_.Position =
        UDim2.new(
        0,
        (S94_.AbsoluteSize.X // 2 - S95_.Size.X.Offset // 2),
        0,
        (S94_.AbsoluteSize.Y // 2 - S95_.Size.Y.Offset // 2)
    )
    ...
    function S137_:CreateTab(S143_arg0)
        ...
        function S154_:AddSection(S164_arg0, S165_arg1)
            ...
            function S184_:AddParagraph(S192_arg0)
                ...
                S198_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
            ...
            function S184_:AddButton(S201_arg0)
                ...
                S207_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
            ...
            function S184_:AddToggle(S211_arg0)
                ...
                S217_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
            ...
            function S184_:AddSlider(S229_arg0)
                ...
                S235_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
                ...
                S1_.InputChanged:Connect(
                    function(S256_arg0)
                        if S248_ and S256_arg0.UserInputType == Enum.UserInputType.MouseMovement then
                            local S257_ =
                                math.clamp(
                                (S256_arg0.Position.X - S239_.AbsolutePosition.X) / S239_.AbsoluteSize.X,
                                0,
                                1
                            )
                ...
                S238_:GetPropertyChangedSignal("Text"):Connect(
                    function()
            ...
            function S184_:AddInput(S260_arg0)
                ...
                S266_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
            ...
            function S184_:AddDropdown(S271_arg0)
                ...
                S278_:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
                ...
                function S273_:Set(S288_arg0)
                    ...
                    for S290_forvar0, S291_forvar1 in S283_:GetChildren() do
                        if
                            S291_forvar1.Name ~= "UIListLayout" and
                                not table.find(S273_.Value, S291_forvar1.OptionText.Text)
                         then
                            S2_:Create(
                                S291_forvar1.ChooseFrame,
                            ...
                            S2_:Create(
                                S291_forvar1.ChooseFrame.UIStroke,
                                TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
                                {
                                    Transparency = 0.999
                                }
                        ...
                        elseif
                            S291_forvar1.Name ~= "UIListLayout" and
                                table.find(S273_.Value, S291_forvar1.OptionText.Text)
                         then
                            S2_:Create(
                                S291_forvar1.ChooseFrame.UIStroke,
                                TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
